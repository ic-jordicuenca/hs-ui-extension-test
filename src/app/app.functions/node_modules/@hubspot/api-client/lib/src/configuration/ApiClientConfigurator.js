...
class ApiClientConfigurator {
    static getParams(config, serverConfigurationClass, observableRequestContextParam, observableResponseContextParam) {
        const params = {
            middleware: this.getMiddleware(config, observableRequestContextParam, observableResponseContextParam),
    ...
    static getMiddleware(config, observableRequestContextParam, observableResponseContextParam) {
        const middleware = [
            this.getHeaderMiddleware(config, observableRequestContextParam, observableResponseContextParam),
        ];
        if (config.httpAgent) {
            middleware.push(this.getHttpAgentMiddleware(config, observableRequestContextParam, observableResponseContextParam));
        }
        return middleware;
    }
    ...
    static getHttpAgentMiddleware(config, observableRequestContextParam, observableResponseContextParam) {
